...
/**
 * Package-private implementation of {@link RegistrationExposeAPI} — the Module Facade for Registration.
 * Resides inside the information-hiding boundary (internal/facade/). Coordinates directly with the
 * application read port — no Command/Query Bus involved (per ADR 0010).
 */
@Component
