 ...
 * performed by the Room domain value objects inside the handler. The {@code roomId} is
 * caller-generated (ADR 0021 Caller-Generated ID): the inbound adapter assigns it and the handler
 * persists the aggregate under that id (never generates one itself).
 *
 * @param roomId   the caller-generated aggregate id
