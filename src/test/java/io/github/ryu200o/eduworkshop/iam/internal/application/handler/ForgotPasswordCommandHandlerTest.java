...
class ForgotPasswordCommandHandlerTest {
    ...
    private ForgotPasswordCommandHandler handler() {
        return new ForgotPasswordCommandHandler(userRepository, oneTimeTokenRepository, parameters, clock);
    }

    @Test
    void forgotPassword_knownEmail_issuesResetToken() {
    ...
    @Test
    void forgotPassword_unknownEmail_returnsNullTokenSilently() {
